...
public class AlbumsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerViewAdapter itemsAdapter = new RecyclerViewAdapter(AlbumsFragment.this.getActivity(), songs, null);
        final RecyclerView clv = (RecyclerView) view.findViewById(R.id.clist);
        clv.setLayoutManager(new LinearLayoutManager(AlbumsFragment.this.getActivity()));
