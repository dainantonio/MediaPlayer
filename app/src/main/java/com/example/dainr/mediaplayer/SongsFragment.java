...
public class SongsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerViewAdapter itemsAdapter = new RecyclerViewAdapter(SongsFragment.this.getActivity(), songs, null);
        final RecyclerView clv = (RecyclerView) view.findViewById(R.id.clist);
        clv.setLayoutManager(new LinearLayoutManager(SongsFragment.this.getActivity()));
